class ReadersController < ApplicationController
  ...
  def destroy
    for trans in @reader.transactions
       trans.destroy
    end
    @reader.destroy
    respond_to do |format|
  ...
  private
    ...
    def reader_params
      params.require(:reader).permit(:reader_id, :reader_name, :reader_mobile_num, :reader_email, :membership_start_date, :membership_end_date)
    end
end
