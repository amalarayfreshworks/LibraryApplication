...
class ReadersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reader" do
    assert_difference('Reader.count') do
      post readers_url, params: { reader: { reader_id: @reader.reader_id + 2, reader_name: @reader.reader_name , reader_mobile_num: @reader.reader_mobile_num} }
    end
  ...
  test "should update reader" do
    patch reader_url(@reader), params: { reader: { reader_id: @reader.reader_id, reader_name: @reader.reader_name } }
